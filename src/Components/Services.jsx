...
const ServicesSection = () => {
  const services = [
    ...
    {
      icon: <Icon icon="fa6-solid:person-running" />,
      title: "Athletics",
      description:
        "Host or join athletic events and gatherings in our versatile space.",
  ...
  return (
    <section id="services" className="py-25 pb-15 md:py-20 bg-white h-auto">
      <div className="mx-auto px-4 max-w-6xl">
        ...
        <h1
          className="text-6xl md:text-4xl text-center font-arabic font-bold text-secondary mb-20"
          data-aos="fade-up"
        ...
        <div className="mb-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {services.map((service, index) => (
              <div
                key={index}
                className="relative bg-[var(--bg-color)] p-6 rounded-lg shadow-[0_0_25px_0px_rgba(0,0,0,0.2)] overflow-hidden text-center group"
                data-aos="fade-up"
                data-aos-duration="1000"
                data-aos-delay={index * 100}
              >
                <div className="absolute inset-0 bg-[var(--secondary-color)] transform -translate-y-full group-hover:translate-y-0 rounded-lg transition-transform duration-500 ease-in-out"></div>

                <div className="relative z-10">
                  <div className="text-6xl text-[var(--secondary-color)] group-hover:text-black mb-4 flex justify-center transition-colors duration-300">
                    {service.icon}
                  </div>
